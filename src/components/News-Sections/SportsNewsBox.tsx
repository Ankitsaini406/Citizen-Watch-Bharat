...
export default function SportsNewsBox({ category, categoryNameHindi }: Props) {
  return (
    <div className="mb-12 border-4 border-orange-700 bg-orange-50 rounded-lg p-2">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-orange-900 border-b-2 border-orange-700 pb-2">
      ...
      {category.news.length > 8 && (
        <div className="text-center mt-6">
          <a
            ...
            className="inline-block bg-orange-700 text-white px-6 py-2 rounded-md hover:bg-orange-800 transition-colors"
          >
