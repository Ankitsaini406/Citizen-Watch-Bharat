...
export default function PoliticalNewsBox({ category, categoryNameHindi }: Props) {
  return (
    <div className="mb-12 border-4 border-red-700 bg-red-50 rounded-lg p-2">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-red-900 border-b-2 border-red-700 pb-2">
      ...
      {category.news.length > 8 && (
        <div className="text-center mt-6">
          <a
            ...
            className="inline-block bg-red-700 text-white px-6 py-2 rounded-md hover:bg-red-800 transition-colors"
          >
