...
export default function BusinessNewsBox({ category, categoryNameHindi }: Props) {
  return (
    <div className="mb-12 border-4 border-green-700 bg-green-50 rounded-lg p-2">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-green-900 border-b-2 border-green-700 pb-2">
