...
export default function InternationalNewsBox({ category, categoryNameHindi }: Props) {
  return (
    <div className="mb-12 border-4 border-purple-700 bg-purple-50 rounded-lg p-2">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-purple-900 border-b-2 border-purple-700 pb-2">
